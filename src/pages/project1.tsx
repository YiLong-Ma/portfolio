                ...
                <div className={styles.body}>
                    <div className={styles.body1}>
                        ...
                        <div className={styles.bodyText1}>
                            ...
                            <div>Multiple Icons and Logos were designed to be shown throughout the app.
                    ...
                    <div className={styles.body1}>
                        <div className={styles.bodyText1}>
                            ...
                            <div>Using FigJam, the team was able to plan out what the core functions of the app would be.
