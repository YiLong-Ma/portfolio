        ...
        <>
            <main className={styles.main}>
                ...
                <div className={styles.header}>
                    ...
                    <h1 className={styles.h}><Link href=".project3" style={{ textDecoration: 'none', color: '#48444B' }}>Project 3</Link></h1>
                    <h1 className={styles.h1}><Link href="4" style={{ textDecoration: 'none', color: '#CABDB9' }}>Project 4</Link></h1>
                </div>
